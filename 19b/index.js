...
function generateItems(today) {
  today = today || newDate();
  return [
    { id: 1, title: 'Meeting with Ben\'s agent.', date: randomDate(addMinutes(today, -60), addMinutes(today, 60))  },
    { id: 2, title: 'Papers review with Tonny.', date: randomDate(addMinutes(today, -5), addMinutes(today, 5)) },
    { id: 3, title: 'Annual party at Eric\'s house.', date: randomDate(addMinutes(today, -5), addMinutes(today, 5))  },
    { id: 4, title: 'Last day to pay off auto credit.', date: randomDate(addMinutes(today, -5), addMinutes(today, 5))  },
    { id: 5, title: 'Call and schedule another meeting with Amanda.', date: randomDate(addMinutes(today, -30), addMinutes(today, 30))  },
    { id: 6, title: 'Don\'t forget to send in financial reports.', date: randomDate(addMinutes(today, -30), addMinutes(today, 30))  }
  ];
}
