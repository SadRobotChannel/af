    ...
    return {
        ...
        execute: function() {
            BookmarkService = (function () {
                ...
                BookmarkService.prototype.saveItem = function (item) {
                    if (!this.doesCategoryExits(item.category))
                        this.createCategory(item.category);
                    this.addItemToCategory(item);
                };
                BookmarkService.prototype.doesCategoryExits = function (category) {
                ...
                BookmarkService.prototype.createCategory = function (category) {
                };
                BookmarkService.prototype.addItemToCategory = function (item) {
                };
