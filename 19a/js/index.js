  ...
  var template =
      '<div class="notifications js-notifications">' +
        ...
        '<ul class="notifications-list">' +
          ...
          '{{/items}}' +
        '</ul>' +
        '<a href="#" class="show-all">Show all faucets</a>' +
      '</div>';
...
function generateItems(today) {
  today = today || newDate();
  return [
    { id: 1, title: 'Meeting with Ben\'s agent.' },
    { id: 2, title: 'Papers review with Tonny.' },
    { id: 3, title: 'Annual party at Eric\'s house.' },
    { id: 4, title: 'Last day to pay off auto credit.' },
    { id: 5, title: 'Call and schedule another meeting with Amanda.' },
    { id: 6, title: 'Don\'t forget to send in financial reports.' }
  ];
}
